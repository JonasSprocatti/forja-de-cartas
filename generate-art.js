...
export default async function handler(req, res) {
  ...
  // o cliente envia "aspect" conforme o layout; padrão 3:2 = janela de arte normal.
  ...
  // moldura segura: arte de fantasia, sem marcas/IP, sem texto na imagem, preenchendo todo o quadro
